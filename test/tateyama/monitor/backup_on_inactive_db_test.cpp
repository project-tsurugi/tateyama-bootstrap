...
class backup_on_inactive_db_test : public ::testing::Test {
public:
    virtual void SetUp() {
        helper_ = std::make_unique<directory_helper>("backup_on_inactive_db_test", 20005);
        helper_->set_up();
...
TEST_F(backup_on_inactive_db_test, begin) {
    std::string command;
    FILE *fp;
    int l;
    int rv;
